...
public record NewStudent(String name, int age) implements Serializable, Cloneable {
    ...
    /*
    This record class is more cleaner than OldStudent example. We just used 'record' instead of 'class'.
    ...
    1. Every member is declared here, is private and final. So, the object is immutable. We can't set new values.
       We can access value by method which is same as the field name.
    2. This record automatically implements hashCode(), equals(), toString() with field variables.
    ...
    6. Record can implements interfaces like - Serializable, Cloneable.
    7. Record can't be abstract because it's a final class.
     */
    ...
    public static void main(String[] args) {
        ...
        System.out.println(student1.getFullIdentity());
        System.out.println(student2.getFullIdentity());
